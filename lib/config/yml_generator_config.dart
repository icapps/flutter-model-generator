...
class YmlGeneratorConfig {
  ...
  YmlGeneratorConfig(PubspecConfig pubspecConfig, String configContent, this.fileName) {
    ...
    yamlContent.forEach((key, value) {
      ...
      final extraImportsForTable = value.containsKey('extra_imports_for_table') ? <String>[] : null;
      ...
      final bool? generateDriftTable = value['generate_drift_table'];
      final bool? generateDriftDaoStorage = value['generate_drift_dao_storage'];
      if (type == 'custom') {
      ...
      if (type == 'enum') {
        ...
        models.add(ObjectModel(
          ...
          generateDriftDaoStorage: generateDriftDaoStorage,
